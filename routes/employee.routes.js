...
router.get("/me/changePassword", isAuth, employeePrivilege, employeeControllers.getChangePassword);
router.post("/me/changePassword", isAuth, employeePrivilege, employeeControllers.postChangePassword);
router.get(
    "/:id/modify",
    isAuth,
    employeePrivilege,
