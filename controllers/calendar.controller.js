                            ...
                            oneToOneFetch
                                .then(([rows, fieldData]) => {
                                    ...
                                    holidayRows.forEach((holiday) => {
                                        ...
                                        const day = daysMap.get(
                                            formatDate.forSql(date)
                                        );
                                        if (day) {
                                    ...
                                    if (isMonthView) {
                                        ...
                                        const daysToAddAtEnd =
                                            totalCellsNeeded -
                                            (totalDaysInMonth + firstDayOfWeek);
                                    ...
                                    response.status(200).json({
                                        ...
                                        days: daysArray,
                                        formattedStart:
                                            formatDate.withOrdinal(startDate),
                                        formattedEnd:
                                            formatDate.withOrdinal(endDate),
                                        formattedMonth: `${startDate.toLocaleString(
                                            "default",
                                            { month: "long" }
